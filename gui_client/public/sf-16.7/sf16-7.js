var Sf167Web = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var Db = (a) => {
      ...
      L = (a, b, ...c) => {
        for (
          var d = 2 * c.length, e = Ib(), f = Jb(8 * d), g = f >> 3, m = 0;
          m < c.length;
          m++
        ) {
          var r = c[m];
    ...
    var Gb = (a) =>
      new Promise((b) => {
        a.onmessage = (f) => {
          ...
          else if ("spawnThread" === g) Hb(f);
          else if ("cleanupThread" === g) Vb(J[f.fb]);
    ...
    function Fb() {
      if (h.mainScriptUrlOrBlob) {
        ...
        a = new Worker(new URL("sf16-7.js", import.meta.url), {
          type: "module",
          name: "em-pthread",
        });
      H.push(a);
    ...
    var bb = (a, b, c, d) => {
      ...
      hc = "undefined" != typeof TextDecoder ? new TextDecoder() : void 0,
      P = (a, b = 0, c = NaN) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
        if (16 < c - b && a.buffer && hc)
          return hc.decode(
        ...
        createNode(a, b, c, d) {
          ...
          S.ha ||
            (S.ha = {
              ...
              link: {
                node: { pa: S.ba.pa, ja: S.ba.ja, ta: S.ba.ta },
                stream: {},
              },
          ...
          16384 === (c.mode & 61440)
            ...
            : 8192 === (c.mode & 61440) &&
              ((c.ba = S.ha.Ia.node), (c.$ = S.ha.Ia.stream));
          ...
          Pa(a, b, c) {
            ...
            if (d) {
              if (16384 === (a.mode & 61440))
                for (var e in d.aa) throw new R(55);
        ...
        $: {
          ...
          write(a, b, c, d, e, f) {
            ...
            if (b.subarray && (!a.aa || a.aa.subarray)) {
              ...
              if (0 === a.da && 0 === e)
                return (a.aa = b.slice(c, c + d)), (a.da = d);
          ...
          ga(a, b, c) {
            1 === c
              ? (b += a.position)
              : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.da);
    ...
    var fb = () => Va(""),
      ...
      La = (a) => {
        "function" === typeof Atomics.hb &&
          (Atomics.hb(A(), a >> 2, a).value.then(Na),
          (a += 128),
      ...
      ib = (a, b, c, d, e) => {
        ...
        b = e >> 3;
        for (c = 0; c < d; c++)
          Mc[c] = w[b + 2 * c] ? w[b + 2 * c + 1] : Fa()[b + 2 * c + 1];
        return (0, Nc[a])(...Mc);
      },
      jb = () => {
        K = 0;
    ...
    var Z = (a, b, c) => oa(a, pa(), b, c),
      nb = (a, b, c, d) => {
        ...
        b = (m) => {
          var r = Math.abs(m);
          return `UTC${0 <= m ? "-" : "+"}${String(Math.floor(r / 60)).padStart(
            2,
            "0"
    ...
    function ob(a, b, c) {
      ...
      if (0 === a) a = Date.now();
      else if (Qc) a = performance.timeOrigin + performance.now();
      else return 52;
    ...
    h.UTF8ToString = ja;
    h.stringToUTF8 = Z;
    var Nc = [Bb, Nb, ac, cb, db, eb, mb, ub, vb, xb, yb, zb, Ab],
      ab,
    ...
    var qa = (h._uci = (a) => (qa = h._uci = C.G)(a)),
      ma = (h._setNnueBuffer = (a, b, c) =>
        (ma = h._setNnueBuffer = C.H)(a, b, c)),
      ka = (h._getRecommendedNnue = (a) =>
        (ka = h._getRecommendedNnue = C.I)(a)),
      Wb = () => (Wb = C.K)(),
      Vc = (h.__emscripten_proxy_main = (a, b) =>
        (Vc = h.__emscripten_proxy_main = C.L)(a, b)),
      Ob = () => (Ob = C.N)(),
      Ja = (a, b, c, d, e, f) => (Ja = C.O)(a, b, c, d, e, f),
      Oa = () => (Oa = C.P)(),
      Pb = (a) => (Pb = C.Q)(a),
      la = (h._malloc = (a) => (la = h._malloc = C.R)(a)),
      Kb = (a, b, c, d, e) => (Kb = C.S)(a, b, c, d, e),
      Ub = (a) => (Ub = C.T)(a),
      $b = (a) => ($b = C.U)(a),
      Pc = (a, b) => (Pc = C.V)(a, b),
      Lc = () => (Lc = C.W)(),
